...
const char* nvclusterlodResultString(nvclusterlod_Result result)
{
  ...
  switch(result)
  {
    ...
    case nvclusterlod_Result::NVCLUSTERLOD_ERROR_EMPTY_DECIMATION_RESULT: return "NVCLUSTERLOD_ERROR_EMPTY_DECIMATION_RESULT";
    case nvclusterlod_Result::NVCLUSTERLOD_ERROR_USER_DECIMATION_FAILED: return "NVCLUSTERLOD_ERROR_USER_DECIMATION_FAILED";
    case nvclusterlod_Result::NVCLUSTERLOD_ERROR_NO_DECIMATION_CALLBACK: return "NVCLUSTERLOD_ERROR_NO_DECIMATION_CALLBACK";
