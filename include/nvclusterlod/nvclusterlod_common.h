...
#define nvclusterlod_defaultVec3u()                                                                                    \
  {                                                                                                                    \
    0u, 0u, 0u                                                                                                         \
  }
...
typedef enum nvclusterlod_Result
{
  ...
  NVCLUSTERLOD_ERROR_CLUSTERING_FAILED,
  NVCLUSTERLOD_ERROR_NODE_OVERFLOW,
  NVCLUSTERLOD_ERROR_LOD_OVERFLOW,
  NVCLUSTERLOD_ERROR_CLUSTER_COUNT_NOT_DECREASING,
  NVCLUSTERLOD_ERROR_INCONSISTENT_GENERATING_GROUPS,
  NVCLUSTERLOD_ERROR_ADJACENCY_GENERATION_FAILED,
  NVCLUSTERLOD_ERROR_OUTPUT_MESH_OVERFLOW,
  NVCLUSTERLOD_ERROR_CLUSTER_GENERATING_GROUPS_MISMATCH,
  NVCLUSTERLOD_ERROR_EMPTY_ROOT_CLUSTER,
  NVCLUSTERLOD_ERROR_INCONSISTENT_BOUNDING_SPHERES,
  NVCLUSTERLOD_ERROR_HIERARCHY_GENERATION_FAILED,
  NVCLUSTERLOD_ERROR_INVALID_ARGUMENT,
  NVCLUSTERLOD_ERROR_UNSPECIFIED,
