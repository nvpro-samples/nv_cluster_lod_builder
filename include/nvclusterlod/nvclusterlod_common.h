...
typedef enum nvclusterlod_Result
{
  ...
  NVCLUSTERLOD_ERROR_CLUSTERING_TRIANGLES_FAILED,  // dropped error from nv_cluster_builder
  NVCLUSTERLOD_ERROR_CLUSTERING_CLUSTERS_FAILED,   // dropped error from nv_cluster_builder
  NVCLUSTERLOD_ERROR_CLUSTERING_NODES_FAILED,      // dropped error from nv_cluster_builder
  ...
  NVCLUSTERLOD_ERROR_EMPTY_DECIMATION_RESULT,
  NVCLUSTERLOD_ERROR_USER_DECIMATION_FAILED,
  NVCLUSTERLOD_ERROR_NO_DECIMATION_CALLBACK,  // callback required if NVCLUSTERLOD_FETCH_MESHOPTIMIZER is OFF
} nvclusterlod_Result;
